...
//                     printf("\nsada(%d %d) asdasd\n", number_individual_population+i, number_individual_population+i+1);
                }
                else{
...
//     printf("number_current_population = %d\n\n\n",number_current_individual_population);
}
...
void update_scalar_fitness() {
    for(int i = 0 ; i < number_current_individual_population;i++) {
        if( factorial_rank_one[i] > factorial_rank_two[i] ) scalar_fitness[i] = 1.0/factorial_rank_two[i] ;
        else if (factorial_rank_one[i] < factorial_rank_two[i]) scalar_fitness[i] = 1.0/factorial_rank_one[i];
        else {
...
// gan lai index_divergents
    for(int i = number_individual_population ; i < number_current_individual_population; i++) {
        index_divergents[i] = 0;
    }
//    for(int i = 0 ; i < number_current_individual_population ;i++) {
//        printf("%d ", skill_factor[i]);
...
//    if ( number_current_individual_population > number_individual_population) {
        for(int i = 0 ; i < number_current_individual_population ;i++) {
...
//        printf("(%d %d )\n",tmp1,tmp2);
        if ( _rand < rmp) {
            ...
            crossover(tmp1,tmp2);
            if (__rand < 0.5) {
                skill_factor[number_individual_population+i] = skill_factor[number_individual_population+i+1] = 1;
                index_divergents[number_individual_population+i] = 1;
                index_divergents[number_individual_population+i+1] = 1;
            } else {
                skill_factor[number_individual_population+i] = skill_factor[number_individual_population+i+1] = 2;
                index_divergents[number_individual_population+i] = 1;
                index_divergents[number_individual_population+i+1] = 1;
            }
        } else  {
